      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 z-50 lg:top-1/3">
        ...
        <nav >
          <ul className="flex flex-col  items-center justify-center md:flex-row text-gray-400">
            <li className="m-2">
              <Link to="../home" className="px-2 py-1 transition-all border border-gray-400 hover:text-gray-100 hover:border-gray-100 hover:px-3">
                Domovská stránka
              </Link>
            </li>
            <li className="m-2">
              <Link to="../portfolio" className="px-2 py-1 transition-all border border-gray-400 hover:text-gray-100 hover:border-gray-100 hover:px-3">
                Portfolio
              </Link>
            </li>
          </ul> 
